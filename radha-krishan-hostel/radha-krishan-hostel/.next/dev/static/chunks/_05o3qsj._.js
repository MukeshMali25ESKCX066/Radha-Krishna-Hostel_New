...
const galleryImages = [
    {
        src: '/images/IMG_5093.jpg',
        alt: 'Radha Krishan Hostel photo 1'
    },
    {
        src: '/images/IMG_5246.jpg',
        alt: 'Radha Krishan Hostel photo 2'
    },
    {
        src: '/images/IMG_5249.jpg',
        alt: 'Radha Krishan Hostel photo 3'
    },
    {
        src: '/images/IMG_5253.jpg',
        alt: 'Radha Krishan Hostel photo 4'
    },
    {
        src: '/images/Screenshot 2025-03-07 122042.png',
        alt: 'Radha Krishan Hostel facilities screenshot'
    },
    {
        src: '/images/WhatsApp Image 2026-09-05 at 10.11.38.jpeg',
        alt: 'Radha Krishan Hostel photo from WhatsApp'
    },
    {
        src: '/images/WhatsApp Image 2026-09-05 at 10.11.39.jpeg',
        alt: 'Radha Krishan Hostel photo from WhatsApp'
    },
    {
        src: '/images/IMG_5091.jpg',
        alt: 'Radha Krishan Hostel photo 8'
    },
    {
        src: '/images/IMG_5092.jpg',
        alt: 'Radha Krishan Hostel photo 9'
    }
];
const mapsUrl = 'https://www.google.com/maps/@26.8248812,75.869886,14.95z?entry=ttu&g_ep=EgoyMDI2MDkwMS4wIKXMDSoASAFQAw%3D%3D';
function Home() {
    _s();
    const [floors, setFloors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(fallbackFloors);
    const [selectedFloor, setSelectedFloor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Basement');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const sliderTimer = setInterval({
                "Home.useEffect.sliderTimer": ()=>{
                    setGalleryIndex({
                        "Home.useEffect.sliderTimer": (current)=>(current + 1) % galleryImages.length
                    }["Home.useEffect.sliderTimer"]);
                }
            }["Home.useEffect.sliderTimer"], 3500);
            return ({
                "Home.useEffect": ()=>clearInterval(sliderTimer)
            })["Home.useEffect"];
        }
    }["Home.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const fetchRooms = {
                "Home.useEffect.fetchRooms": ()=>{
                    fetch('/api/rooms').then({
                        "Home.useEffect.fetchRooms": (response)=>{
                            if (!response.ok) throw new Error('Room API unavailable');
                            return response.json();
                        }
                    }["Home.useEffect.fetchRooms"]).then({
                        "Home.useEffect.fetchRooms": ({ rooms })=>{
                            const grouped = fallbackFloors.map({
                                "Home.useEffect.fetchRooms.grouped": (floor)=>({
                                        name: floor.name,
                                        rooms: []
                                    })
                            }["Home.useEffect.fetchRooms.grouped"]);
                            rooms.forEach({
                                "Home.useEffect.fetchRooms": (room)=>{
                                    const floor = grouped.find({
                                        "Home.useEffect.fetchRooms.floor": (item)=>item.name === room.block
                                    }["Home.useEffect.fetchRooms.floor"]);
                                    if (floor) floor.rooms.push(room);
                                }
                            }["Home.useEffect.fetchRooms"]);
                            setFloors(grouped);
                            setSelectedFloor({
                                "Home.useEffect.fetchRooms": (current)=>current && grouped.some({
                                        "Home.useEffect.fetchRooms": (floor)=>floor.name === current
                                    }["Home.useEffect.fetchRooms"]) ? current : grouped[0]?.name || 'Basement'
                            }["Home.useEffect.fetchRooms"]);
                        }
                    }["Home.useEffect.fetchRooms"]).catch({
                        "Home.useEffect.fetchRooms": ()=>setFloors(fallbackFloors)
                    }["Home.useEffect.fetchRooms"]);
                }
            }["Home.useEffect.fetchRooms"];
            fetchRooms();
            ...
            const handleFocus = {
                "Home.useEffect.handleFocus": ()=>fetchRooms()
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: "Your comfortable home away from home in Jaipur — a clean, secure and student-friendly stay with easy room availability and trusted support."
                            }, void 0, false, {
                                fileName: "[project]/app/page.js",
                                lineNumber: 81,
                                columnNumber: 169
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        ].map((card)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: facilities.map((facility)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        children: facility[0]
                                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                id: "gallery",
                className: "section gallery-slider-wrap",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Home, "+cdyUXGvna4GBwzRo+xakbnsrRU=");
_c = Home;
var _c;
